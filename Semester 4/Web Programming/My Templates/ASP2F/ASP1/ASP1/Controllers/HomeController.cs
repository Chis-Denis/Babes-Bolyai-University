...
public class HomeController : Controller
{
    ...
    public async Task<IActionResult> ShowReservations(string personName, string specificDate, string destinationCity, int? pageNumber)
    {
        ...
        var pageSize = 5; // Define the number of reservations to display per page. You can adjust this value.
        // Query reservations for the specific person.
        var reservations = _context.Reservations
                                   .Where(r => r.person == personName);

        // Create a paginated list from the queryable reservations.
        // pageNumber ?? 1 ensures that if pageNumber is null, it defaults to the first page.
