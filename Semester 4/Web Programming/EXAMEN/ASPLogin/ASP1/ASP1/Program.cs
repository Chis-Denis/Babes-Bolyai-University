...
//the pricing logic with the already booked or unbooked rooms is not working

//i am seeing the same price, the price does not change but for the same period of time i have reserved half of the available rooms

// same price but only one available room

//make me able to delete reservations, and also put a button on the menu on the top so i can go to my reservations

//do i use HomeController and Index.cshtml should i keep them?