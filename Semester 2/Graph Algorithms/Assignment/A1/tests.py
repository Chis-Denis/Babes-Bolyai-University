...
class Tests(unittest.TestCase):
    ...
    def test_parse_inbound_edge(self):
        ...
        g.add_edge(1, 4)
        g.add_edge(0, 1)
        self.assertEqual(set(g.transposed_iterator(1)), {0})
    ...
    def find_lowest_cost_walk(self):
        ...
        g.set_edge_cost(3, 0, 4)
        g.set_edge_cost(0, 2, 5)
        g.set_edge_cost(2, 1, 6)
        g.set_edge_cost(1, 3, 7)
        lowest_cost_walk(g, 0, 3)
        self.assertEqual(lowest_cost_walk(g, 0, 3), 8)
        g.set_edge_cost(3, 0, -1)
        lowest_cost_walk(g, 0, 3)
        self.assertEqual(lowest_cost_walk(g, 0, 3), 7)
